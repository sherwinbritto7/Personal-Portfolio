        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200 leading-relaxed">
              ...
              <p>
                ...
                clean interfaces that prioritize usability and performance.
              </p>

              <p>
                Outside of coding, I enjoy learning new technologies and
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
            {highlights.map((item, idx) => (
              <div
                key={idx}
                className="group relative glass p-8 rounded-2xl animate-fade-in transition-all duration-300 hover:-translate-y-2 hover:bg-white/10 hover:shadow-xl hover:shadow-primary/5 border border-white/5 hover:border-primary/50"
                style={{ animationDelay: `${(idx + 1) * 150}ms` }}
              >
                {/* Icon Container */}
                <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 transition-colors duration-300 group-hover:bg-primary group-hover:text-primary-foreground">
